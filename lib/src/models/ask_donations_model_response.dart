class AskDonationsModel {
  String? message;
  List<AskDonation>? data;

  AskDonationsModel({this.message, this.data});

  AskDonationsModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      data = <AskDonation>[];
      json['data'].forEach((v) {
        data!.add(new AskDonation.fromJson(v));
      });
    }
  }
...
class AskDonation {
  ...
  AskDonation.fromJson(Map<String, dynamic> json) {
    id = json['id'];
